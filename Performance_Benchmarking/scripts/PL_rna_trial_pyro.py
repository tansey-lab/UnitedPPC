...
from Performance_Benchmarking.scripts.pyro_model import generate_pyro_data, run_pyro_svi, run_pyro_svi_weighted, run_pyro_svi_alter, svi_loss
from Performance_Benchmarking.scripts.utils import test_train_split_met_rna, saving_data_for_pyro_posterior, saving_data_for_testing
...
if __name__ == "__main__":
    ...
    parser.add_argument('-rd', '--results_directory', help="the path of the results directory", required=False,
                        type=str, default="/data1/reznike/xiea1/MetabolicModel/results/results_RNA_ccRCC/RC18")
