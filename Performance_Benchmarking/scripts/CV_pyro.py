...
import torch
import argparse
from Performance_Benchmarking.scripts.pyro_model import run_pyro_svi, run_pyro_svi_weighted
...
if __name__ == "__main__":
    ...
    W_loc, W_scale, H_loc, H_scale, loss_list = run_pyro_svi_weighted(N, J, K, n_batch, start_row, stop_row, n_obs, orders, n_mets, n_genes, n_steps, lr)
